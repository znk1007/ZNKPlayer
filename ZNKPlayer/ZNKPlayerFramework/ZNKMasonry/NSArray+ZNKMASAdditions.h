...
typedef NS_ENUM(NSUInteger, ZNKMASAxisType) {
    ZNKMASAxisTypeHorizontal,
    ZNKMASAxisTypeVertical
};

@interface NSArray (ZNKMASAdditions)

/**
 *  Creates a ZNKMASConstraintMaker with each view in the callee.
 ...
 */
- (NSArray *)mas_makeConstraints:(void (NS_NOESCAPE ^)(ZNKMASConstraintMaker *ZNKMAke))block;
 ...
 */
- (NSArray *)mas_updateConstraints:(void (NS_NOESCAPE ^)(ZNKMASConstraintMaker *ZNKMAke))block;
 ...
 *  @return Array of created/updated ZNKMASConstraints
 */
- (NSArray *)mas_remakeConstraints:(void (NS_NOESCAPE ^)(ZNKMASConstraintMaker *ZNKMAke))block;
