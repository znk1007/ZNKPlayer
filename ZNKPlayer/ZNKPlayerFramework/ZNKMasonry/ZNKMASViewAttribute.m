...
@implementation ZNKMASViewAttribute
...
- (BOOL)isEqual:(ZNKMASViewAttribute *)viewAttribute {
...
- (NSUInteger)hash {
    return ZNKMAS_NSUINTROTATE([self.view hash], ZNKMAS_NSUINT_BIT / 2) ^ self.layoutAttribute;
}
